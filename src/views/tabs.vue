<template>
  <div class="container">
    ...
    <div class="add-appointment">
      <el-button type="primary" :icon="Plus" @click="addAppointment">新增供应商</el-button>
    </div>
    <div class="add-appointment">
      <h3>供应商列表</h3>
    </div>
    ...
    <!-- 添加或编辑供应商的表单 -->
    <el-dialog v-model="dialogVisible" title="添加/编辑供应商">
      <el-form :model="formData" :rules="formRules">
        <el-form-item label="供应商名称" prop="name">
          <el-input v-model="formData.name"></el-input>
        </el-form-item>
        <el-form-item label="供应商联系方式" prop="date">
          <el-input v-model="formData.date"></el-input>
        </el-form-item>
        <el-form-item label="供应商地址" prop="date">
    ...
    <!-- 确认取消供应商的对话框 -->
    <el-dialog v-model="cancelDialogVisible" title="删除供应商">
      <div style="margin-bottom: 20px;font-size: 18px">确定要删除此供应商吗？</div>
...
for (let i = 1; i <= 50; i++) {
  appointments.value.push({
    ...
    name: `供应商${i}`,
    address: `地址${i}`,
    date: `138089098${i.toString().padStart(2, '0')}`,
  });
}
...
const formData = ref({}); // 添加或编辑供应商的表单数据
const formRules = ref({
  name: [
...
const dialogVisible = ref(false); // 是否显示添加或编辑供应商的对话框
